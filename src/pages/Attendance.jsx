...
export default function Attendance() {
  ...
  const filtered = useMemo(() => {
    return attendance.filter((rec) => {
      ...
      const matchesDate = rec.date === date;
    ...
    <div>
      ...
      >
        <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-4 flex items-center gap-3">
          ...
          <div>
            <p className="text-2xl font-bold tabular-nums text-gray-900">{presentCount}</p>
        ...
        <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-4 flex items-center gap-3">
          ...
          <div>
            <p className="text-2xl font-bold tabular-nums text-gray-900">{absentCount}</p>
        ...
        <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-4 flex items-center gap-3">
          ...
          <div>
            <p className="text-2xl font-bold tabular-nums text-gray-900">{halfDayCount}</p>
        ...
        <div className="flex flex-col md:flex-row gap-3">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="pl-9 pr-4 py-2.5 rounded-lg border border-gray-200 text-sm text-gray-700 bg-white focus:outline-none focus:border-[#d4af37] focus:ring-1 focus:ring-[#d4af37]/30 transition"
            />
          </div>
          <div className="relative">
            <select
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-100 bg-gray-50/50">
                ...
                <th className="text-left px-5 py-3 text-xs font-semibold tracking-wide text-gray-500 uppercase hidden sm:table-cell">
                  Check-in
                </th>
                <th className="text-left px-5 py-3 text-xs font-semibold tracking-wide text-gray-500 uppercase hidden sm:table-cell">
                  Check-out
                    ...
                    <td className="px-5 py-3.5">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-500 sm:hidden">{rec.employeeId}</p>
                        </div>
                      </div>
                    </td>
